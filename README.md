...
```bash
export STRATA_VERSION=1.9.6                                  # or "latest"
...
```bash
cosign verify ghcr.io/bails309/strata-client/backend:1.9.6 \
...
```bash
cosign download attestation ghcr.io/bails309/strata-client/backend:1.9.6 \
