...
describe("endpoint wrapper coverage", () => {
  ...
  const rows: Row[] = [
    ...
    [
      "createApprovalRole",
      () => createApprovalRole({ name: "r" }),
      "/api/admin/approval-roles",
      "POST",
    ],
    [
      "updateApprovalRole",
      () => updateApprovalRole("r1", { name: "r2" }),
      "/api/admin/approval-roles/r1",
      "PUT",
    ],
    [
      "deleteApprovalRole",
      () => deleteApprovalRole("r1"),
      "/api/admin/approval-roles/r1",
      "DELETE",
    ],
    [
      "getRoleAssignments",
      () => getRoleAssignments("r1"),
      "/api/admin/approval-roles/r1/assignments",
      "GET",
    ],
    [
      "setRoleAssignments",
      () => setRoleAssignments("r1", ["u1"]),
      "/api/admin/approval-roles/r1/assignments",
      "PUT",
    ],
    [
      "getRoleAccounts",
      () => getRoleAccounts("r1"),
      "/api/admin/approval-roles/r1/accounts",
      "GET",
    ],
    [
      "setRoleAccounts",
      () => setRoleAccounts("r1", [{ dn: "CN=a" }]),
      "/api/admin/approval-roles/r1/accounts",
      "PUT",
    ],
    // Account mappings
    ...
    [
      "createAccountMapping",
      () => createAccountMapping({ user_id: "u1", managed_ad_dn: "CN=a" }),
      "/api/admin/account-mappings",
      "POST",
    ],
    [
      "deleteAccountMapping",
      () => deleteAccountMapping("m1"),
      "/api/admin/account-mappings/m1",
      "DELETE",
    ],
    [
      "getUnmappedAccounts",
      () => getUnmappedAccounts("cfg1"),
      "/api/admin/ad-sync-configs/cfg1/unmapped-accounts",
      "GET",
    ],
    ...
    [
      "requestCheckout",
      () => requestCheckout({ managed_ad_dn: "CN=a" }),
      "/api/user/checkouts",
      "POST",
    ],
    ...
    [
      "revealCheckoutPassword",
      () => revealCheckoutPassword("co1"),
      "/api/user/checkouts/co1/reveal",
      "GET",
    ],
    [
      "retryCheckoutActivation",
      () => retryCheckoutActivation("co1"),
      "/api/user/checkouts/co1/retry",
      "POST",
    ],
    ["getPendingApprovals", () => getPendingApprovals(), "/api/user/pending-approvals", "GET"],
    [
      "updateDns",
      () => updateDns({ dns_enabled: true, dns_servers: "1.1.1.1", dns_search_domains: "a.b" }),
      "/api/admin/settings/dns",
      "PUT",
    ],
    // Tags
