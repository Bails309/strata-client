...
const mockClient = {
  ...
  sendKeyEvent: vi.fn(),
  get onerror() { return mockClientOnerror; },
  set onerror(fn: any) { mockClientOnerror = fn; },
  get onstatechange() { return mockClientOnstatechange; },
  set onstatechange(fn: any) { mockClientOnstatechange = fn; },
};
...
vi.mock('guacamole-common-js', () => ({
  default: {
    ...
    Keyboard: vi.fn(function() { return { onkeydown: null, onkeyup: null }; }),
  },
}));
