...
```bash
export STRATA_VERSION=1.5.2                                  # or "latest"
...
```bash
cosign verify ghcr.io/bails309/strata-client/backend:1.5.2 \
...
```bash
cosign download attestation ghcr.io/bails309/strata-client/backend:1.5.2 \
