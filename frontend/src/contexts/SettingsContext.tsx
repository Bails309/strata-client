...
export const SettingsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const formatDateTime = useCallback((date: string | number | Date | null) => {
    return formatUtil(date, timeSettings);
  }, [timeSettings]);

  return (
    <SettingsContext.Provider value={{ settings, timeSettings, loading, refreshSettings, updateSettings, formatDateTime }}>
      {children}
