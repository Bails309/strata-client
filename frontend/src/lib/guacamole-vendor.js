/* Vendored Guacamole client (1.6.0) from sol1/rustguac. Do not edit. */
(function(){
var Guacamole = window.Guacamole = window.Guacamole || {};
/* === Namespace.js === */
/*
...
Guacamole.SessionRecording = function SessionRecording(source, refreshInterval) {
     ...
     * activity â€” idle frames are tiny, active frames are large.
     *
...
Guacamole.Client = function(tunnel) {
    ...
    var instructionHandlers = {
        ...
        "h264": function(parameters) {
            ...
            // [strata-diag] Log first h264 frame to confirm passthrough is active
            if (!guac_client._h264FirstSeen) {
                guac_client._h264FirstSeen = true;
                if (typeof console !== 'undefined')
                    console.info('[strata] First H.264 frame received: ' + width + 'x' + height + ' keyframe=' + isKeyFrame + ' supported=' + Guacamole.H264Decoder.isSupported());
            }
