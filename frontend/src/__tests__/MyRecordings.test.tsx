...
describe("MyRecordings", () => {
  ...
  it("formats hours duration", async () => {
    vi.mocked(getMyRecordings).mockResolvedValue([makeRecording({ duration_secs: 3661 })]);
    await act(async () => {
      render(<MyRecordings />);
    });
  ...
  it("formats seconds-only duration", async () => {
    vi.mocked(getMyRecordings).mockResolvedValue([makeRecording({ duration_secs: 30 })]);
    await act(async () => {
      render(<MyRecordings />);
    });
  ...
  it("shows dash for null duration", async () => {
    vi.mocked(getMyRecordings).mockResolvedValue([makeRecording({ duration_secs: null })]);
    await act(async () => {
      render(<MyRecordings />);
    });
