          ...
          <>
            ...
            <section>
              ...
              <p className="text-[0.7rem] text-txt-tertiary mb-2">
                Text copied within the remote session appears here. Changes below will affect the remote clipboard.
              </p>
              {!clipboardVisible ? (
                <button
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                  {session.filesystems.map((fs, i) => (
                    <button
                      ...
                      onClick={() => { setActiveFsIndex(i); setPanel('filebrowser'); }}
                    >
              ...
              <section>
                ...
                {shareUrl ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    <p className="text-[0.7rem] text-txt-tertiary">
                      Share this link to grant temporary view access. The link expires when you disconnect.
                    </p>
                    <div
                      style={{
                        display: 'flex',
                  ...
                  <button className="btn-sm-primary w-full" style={{ justifyContent: 'center', fontSize: '0.75rem' }} onClick={onShare}>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="text-[0.65rem] text-txt-tertiary mt-auto pt-4 text-center" style={{ opacity: 0.6 }}>
              Press <kbd style={{ padding: '1px 5px', borderRadius: 3, border: '1px solid var(--color-border)', background: 'var(--color-surface-secondary)', fontSize: '0.6rem' }}>Ctrl+Alt+Shift</kbd> to toggle this menu
            </div>
          </>
        ) : (
          /* ── File Browser Panel ── */
          activeFsIndex !== null && session.filesystems[activeFsIndex] && (
            <FileBrowser
