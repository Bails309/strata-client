...
describe('ConfirmModal', () => {
  ...
  it('renders title and message when open', () => {
    render(<ConfirmModal isOpen={true} title="Delete?" message="Are you sure?" onConfirm={onConfirm} onCancel={onCancel} />);
  ...
  it('renders danger icon when isDangerous', () => {
    const { container } = render(
      <ConfirmModal isOpen={true} title="T" message="M" onConfirm={onConfirm} onCancel={onCancel} isDangerous={true} />,
    );
  ...
  it('does not render danger icon when not isDangerous', () => {
    const { container } = render(
      <ConfirmModal isOpen={true} title="T" message="M" onConfirm={onConfirm} onCancel={onCancel} isDangerous={false} />,
    );
