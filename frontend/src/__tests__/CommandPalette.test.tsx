...
const mockConnections = [
  { id: 'c1', name: 'Dev Server', protocol: 'rdp', hostname: 'dev.local', port: 3389, folder_name: 'Work' },
  { id: 'c2', name: 'Prod DB', protocol: 'ssh', hostname: 'db.prod.local', port: 22, description: 'Production database' },
