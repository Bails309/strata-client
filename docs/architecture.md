...
outbound_shares ──── v1.11.0+ Outbound Quick-Share submissions: id (uuid), user_id FK, session_id, connection_id, filename, byte_len, mime_type, justification, sealed_dek (Vault-Transit ciphertext), ciphertext_path, dlp_score, dlp_flags (text[]), status (pending|approved|denied|downloaded|purged), decision_user_id FK, decision_reason, decision_at, download_token, download_token_used_at, expires_at, created_at, updated_at
